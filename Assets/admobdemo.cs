...
//            Debug.Log(KeyCode.Escape+"-----------------");
    ...
    void initAdmob()
    {
          ...
          //  isAdmobInited = true;
            ...
            ad.initAdmob("ca-app-pub-3779310553481967/5839972138", "ca-app-pub-3779310553481967~4363238934");
        //   ad.setTesting(true);
...
//        Debug.Log("handler onAdmobNativeBannerEvent---" + eventName + "   " + msg);
    ...
    {
        StartCoroutine(CallAdmobShowBanner());
    }

    IEnumerator CallAdmobShowBanner()
    {
    ...
    {
        StartCoroutine(CallAdmobShowInterstitial());
    }

    IEnumerator CallAdmobShowInterstitial()
    {
        yield return new WaitForSeconds(0.5f);
    ...
    public void AdmobShowVideo()
    {
        StartCoroutine(CallAdmobShowVideo());
    }

    IEnumerator CallAdmobShowVideo()
    {
        yield return new WaitForSeconds(0.5f);
